...
class Slide extends React.Component{
  ...
  if(this.state.loggedin)
      login=(<div style={{position:'absolute',left:'1170px',bottom:'590px'}}><h3 className='Username'>{this.state.name}</h3><img alt='googleimg' style={{borderRadius:'50%',width:'65px'}} src={this.state.imageurl}/></div>)
  return(
  <div >{login}</div>
